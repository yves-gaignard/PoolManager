...
static const char* TAG = "PM_Web_Server";
...
void PM_Web_Server_handleRoot(HTTPRequest * req, HTTPResponse * res);
void PM_Web_Server_handle404(HTTPRequest * req, HTTPResponse * res);

void PM_Web_Server_setup() {
  // For every resource available on the server, we need to create a ResourceNode
  // The ResourceNode links URL and HTTP method to a handler function
  ResourceNode * nodeRoot = new ResourceNode("/", "GET", &PM_Web_Server_handleRoot);
  ResourceNode * node404  = new ResourceNode("", "GET", &PM_Web_Server_handle404);
