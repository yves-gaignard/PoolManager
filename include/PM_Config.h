...
// { Start , End, Priority }  
  ...
  {  6,  8,  1},  // The main priority 1 is allocated to the morning
  {  8,  9,  1},  // The main priority 1 is allocated to the morning
  {  9, 10,  1},  // The main priority 1 is allocated to the morning
